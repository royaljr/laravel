...
<head>
   ...
   <script type="text/javascript">
     function checkDelete(){
        check = confirm('Are you sure to delete this data?');
          if (check) {
            return true;
          }else{
            return false;
                   ...
                   <ul class="nav top-menu">
                       ...
                       <li class="dropdown" id="header_inbox_bar">
                           ...
                           <ul class="dropdown-menu extended inbox">
                               ...
                               <li>
                                  <a href="#">
                                    <span class="photo"><img src="{{asset('public/admin_assets')}}/img/avatar-mini.png" alt="avatar" />
                                    </span>
                  									<span class="subject">
        ...
        <div id="sidebar" class="nav-collapse collapse">
         ...
         <!-- BEGIN SIDEBAR MENU -->
          <ul class="sidebar-menu">
              ...
              <li class="sub-menu">
                  <a href="{{URL::to('/manage-post')}}" class="">
                      <i class="icon-tasks"></i>
